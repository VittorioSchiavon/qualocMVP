    ...
    <footer>
      ...
      <div className={styles.container}>
        <div className={styles.column}>
          ...
          <li>
          <li>
              <a href="/chiSiamo">Come usare qualoc</a>
            </li>
            <li>
              <a href="/FAQ">Come vendere su qualoc</a>
            </li>
              <a href="/chiSiamo">Assistenza</a>
            </li>
            <li>
              <a href="/chiSiamo">Privacy e dati</a>
            </li>
        ...
        <div className={styles.column}>
          ...
          <ul>
            ...
            <li>
              <a href="#">Politiche di reso e rimborso</a>
            </li>
            <li>
              <a href="#">Spedizioni</a>
            </li>
      ...
      <div className={styles.bottom}>
        <p>&copy; 2023 Qualoc. Tutti i diritti riservati.</p>
      </div>
    </footer>
  );
};
